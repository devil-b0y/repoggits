  ...
  return <div className="submission-studio">
    <header className="studio-hero">
      <div className="studio-hero-copy">
        ...
        <a className="studio-start" href="#studio-section-1" onClick={()=>setStep(1)}>Let’s tell your story <ArrowUpRight size={18}/></a>
