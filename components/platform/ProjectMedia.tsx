...
export default function ProjectMedia({project}:{project:Project}) {
  ...
  return <section className="project-media" aria-label="Project video and photos">
    <div className="media-main">
      ...
      {selected==='cover'&&d.videoUrl&&<div className="media-watch"><button className="media-play" onClick={()=>setSelected('video')}><Play size={24} fill="currentColor"/> Watch working demo</button></div>}
