...
export default function ProjectMedia({project}:{project:Project}) {
  ...
  return <section className="project-media" aria-label="Project video and photos">
    <div className="media-main">
      ...
      {d.videoUrl&&!playing&&<div className="media-watch"><button className="media-play" onClick={()=>setSelected('video')}><Play size={24} fill="currentColor"/> Watch working demo</button></div>}
