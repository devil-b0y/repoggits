...
function Content(){
 ...
 const [selected,setSelected]=useState<string[]>([]),[reason,setReason]=useState(''),[notice,setNotice]=useState(''),[actionError,setActionError]=useState(''),[busy,setBusy]=useState(false),[toast,setToast]=useState('');
 ...
 async function onCardReviewed(){setToast('Project updated successfully.');await reload();}
