...
// Still in the author's hands: a draft, a version sent back for changes, or one awaiting review (editing it
// resubmits with cleared votes; see updateVersion in lib/projects.ts). Both the editor and rename accept these.
const isEditable=(p:Project)=>['draft','changes_requested','pending'].includes(p.version.status)&&!p.archived;
